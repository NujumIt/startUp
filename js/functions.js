...
function registerFormValidation() {
	...
	$( "#register-form" ).on( "submit" , function( event ) {
	    if ( event.isDefaultPrevented() ) {
		    var errorContent = '<i class="rf-error-icon fa fa-close"></i>' +
		                       errorMsg;
...
function rfSubmitForm(){var a=$("#rfName").val(),b=$("#rfEmail").val(),c=$("#rfPhoneNum").val();$.ajax({type:"POST",url:"./php/rf-process.php",data:"rfName="+a+"&rfEmail="+b+"&rfPhoneNum="+c,success:function(a){"success"==a?rfSuccess():(rfError(),rfSubmitMSG(!1,a))}})}function rfSuccess(){var a=$(".rf-notifications").data("success-msg"),b="Thank you for your submission :)",c=a?a:b;$("#register-form")[0].reset();var d='<i class="rf-success-icon fa fa-check"></i>'+c;rfSubmitMSG(!0,d),$(".rf-notifications-cont").addClass("sent"),$(".rf-notifications").css("opacity",0),$(".rf-notifications").slideDown(300).animate({opacity:1},300).delay(5e3).slideUp(400)}function rfError(){$(".rf-notifications").css("opacity",0),$(".rf-notifications").slideDown(300).animate({opacity:1},300),$(".rf-notifications-cont").removeClass("sent")}function rfSubmitMSG(a,b){var c;c="shake animated",$(".rf-notifications").delay(300).addClass(c).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",function(){$(this).removeClass("shake bounce animated")}),$(".rf-notifications").children(".rf-notifications-cont").html(b)}
